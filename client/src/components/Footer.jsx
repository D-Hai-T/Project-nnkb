...
const Footer = () => {
  ...
  const columnOneLinks = ["home", "dashboard", "jobs", "features"];
  const seekerLinks = [
    "resumeBuilder",
    "jobListings",
    "careerGuidance",
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-5">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      {submitted ? t("footer.newsletter.success") : t("footer.newsletter.cta")}
                    </motion.button>
                  </form>
                </div>
              </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-2xl font-bold text-white">{t("common.brand")}</h3>
                </div>
                <p className="mt-4 text-gray-400">{t("footer.brandDescription")}</p>
              </div>
            ...
            {/* Column 2 */}
            <motion.div variants={itemVariants}>
              <h3 className="text-xl font-semibold text-white mb-6 pb-2 border-b border-gray-800">{t("footer.columns.jobSeekers")}</h3>
              <ul className="space-y-3">
                <li>
                ...
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
                    {t("footer.links.jobListings")}
                  </a>
                </li>
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
                    {t("footer.links.careerGuidance")}
                  </a>
                </li>
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
                    {t("footer.links.skillDevelopment")}
                  </a>
                </li>
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
                    {t("footer.links.interviewPrep")}
                  </a>
                </li>
              </ul>
            </motion.div>
            ...
            {/* Column 3 */}
            <motion.div variants={itemVariants}>
              <h3 className="text-xl font-semibold text-white mb-6 pb-2 border-b border-gray-800">{t("footer.columns.resources")}</h3>
              <ul className="space-y-3">
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
            ...
            {/* Column 4 */}
            <motion.div variants={itemVariants}>
              <h3 className="text-xl font-semibold text-white mb-6 pb-2 border-b border-gray-800">{t("footer.columns.support")}</h3>
              <ul className="space-y-3">
                <li>
                  <a href="/" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center">
                    <span className="text-blue-500 mr-2">→</span>
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-bold text-xl">{t("common.brand")}</span>
          </div>
          
          <div className="text-sm text-gray-500">
            {t("footer.copy", { year: currentYear, brand: t("common.brand") })}
          </div>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="/" className="text-sm text-gray-500 hover:text-blue-400 transition-colors duration-300">{t("footer.links.privacy")}</a>
            <a href="/" className="text-sm text-gray-500 hover:text-blue-400 transition-colors duration-300">{t("footer.links.termsShort")}</a>
            <a href="/" className="text-sm text-gray-500 hover:text-blue-400 transition-colors duration-300">{t("footer.links.sitemap")}</a>
          </div>
        </motion.div>
      </div>
