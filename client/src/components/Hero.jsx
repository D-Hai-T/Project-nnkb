...
const Hero = () => {
  ...
  const stats = [
    { icon: FiBriefcase, number: "50K+", label: "jobs" },
    { icon: FiUsers, number: "1M+", label: "seekers" },
    { icon: FiTrendingUp, number: "95%", label: "success" }
  ];
      ...
      <section className="relative overflow-hidden mx-4 my-6 lg:mx-8 lg:my-10 rounded-3xl shadow-2xl">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
          <div className="text-center">
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <span className="text-sm">{t(`hero.stats.${stat.label}`)}</span>
                </motion.div>
              ))}
            </motion.div>
                ...
                <div className="relative bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-white/20">
                  <div className="flex flex-col md:flex-row">
                    ...
                    >
                      ...
                      />
                      <span className="relative z-10">{t("common.buttons.searchJobs")}</span>
            ...
            >
              <span className="mr-4 text-lg font-medium">{t("hero.popularSearches")}</span>
              <div className="flex flex-wrap justify-center gap-3 mt-3">
                {popularTags.map((tag, i) => (
                  ...
                  >
                    ...
                    />
                    <span className="relative z-10">{t(`hero.tags.${tag}`)}</span>
                  </motion.button>
                ))}
              </div>
            </motion.div>
